...
export const demoData: DemoData = {
  ...
  attendance: [
    { key: 'attendance-sari-today', userKey: 'user-sari-utami', date: '2026-08-06', checkIn: null, checkOut: null, status: 'unknown', locationKey: null, syncState: 'idle' },
    ...
    { key: 'attendance-sari-aug5', userKey: 'user-sari-utami', date: '2026-08-05', checkIn: '08:05', checkOut: '17:03', status: 'pending-sync', locationKey: 'location-kantor-pusat', syncState: 'queued' },
    { key: 'attendance-sari-aug4', userKey: 'user-sari-utami', date: '2026-08-04', checkIn: '08:19', checkOut: '17:00', status: 'late', locationKey: 'location-kantor-pusat', syncState: 'synced' },
    { key: 'attendance-sari-aug3', userKey: 'user-sari-utami', date: '2026-08-03', checkIn: '08:00', checkOut: '17:00', status: 'present', locationKey: 'location-kantor-pusat', syncState: 'synced' },
